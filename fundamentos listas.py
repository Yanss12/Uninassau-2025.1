...
# append(elemento): Inserir um elemento ao final da lista1.
lista1.append(7)
lista1.append(14)
lista1.append(21)
...
# pop(índice): Remove um elemento de uma lista1, se o índice não estiver definido, remove o ultimo elemento
lista1.pop()
